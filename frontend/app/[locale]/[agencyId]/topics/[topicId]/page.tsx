        ...
        <div className="">
          ...
          <div className="container mt-10 flex text-out">
            ...
            <div className="font-semibold text-base text-black-700 pb-7 flex">
                <div>{filteredQuestions.length} {locale === 'ms' ? 'soalan topik' : 'questions in'} &nbsp;</div>
                <div>{locale === 'ms' ? selectedTopic?.title_ms : selectedTopic?.title}</div>
              </div>
            ...
            <div className="pl-10 w-[500px]">
              <div className="font-semibold text-base text-black-700">
                <TopicList topics={topics} locale={locale} selectedTopicId={parseInt(topicId, 10)} />
              </div>
            </div>
          </div>
