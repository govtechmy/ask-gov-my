  ...
  'inline-flex select-none items-center justify-center gap-1.5 rounded-lg whitespace-nowrap text-start font-medium active:translate-y-[0.5px] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-30',
  {
    variants: {
      variant: {
        ...
        secondary:
          'border border-outline-200 hover:border-outline-300 bg-white focus:border-outline-200 focus:ring focus:ring-offset-0 focus:ring-outline-400/20 shadow-button disabled:opacity-40 disabled:cursor-not-allowed',
        'secondary-myds':
        ...
        tertiary:
          'hover:bg-washed-100 focus:ring focus:ring-offset-0 focus:ring-outline-400/20  disabled:opacity-40 disabled:cursor-not-allowed',
        'tertiary-colour':
